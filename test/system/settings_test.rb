...
class SettingsTest < ApplicationSystemTestCase
  ...
  test "creating a Setting" do
    ...
    fill_in "Language", with: @setting.language
    fill_in "Post Per", with: @setting.post_per
    fill_in "Push Interval", with: @setting.push_interval
    fill_in "Push Mail", with: @setting.push_mail
    fill_in "Week Start", with: @setting.week_start
