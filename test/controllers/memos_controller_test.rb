...
class MemosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create memo" do
    assert_difference('Memo.count') do
      post memos_url, params: { memo: { body: @memo.body, project_id: @memo.project_id, title: @memo.title } }
    end
  ...
  test "should update memo" do
    patch memo_url(@memo), params: { memo: { body: @memo.body, project_id: @memo.project_id, title: @memo.title } }
